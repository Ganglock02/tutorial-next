        ...
        <div className="mt-4 mx-auto flex grow flex-col gap-4 md:flex-row w-4/5">
                <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
                    <p className={`${bebas.className} text-xl text-gray-800 md:text-3xl md:leading-normal`}>
                        <strong>Mi primera aplicación</strong> Tutorial para aprender a usar Next.js
                    </p>
                    <a href="#" className="flex items-center gap-5 self-start rounded-lg bg-blue-500 px-6
